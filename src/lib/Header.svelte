<script lang="ts">
  import {metaInfo} from "../stores/contentStore";
    ...
    <div class="col-sm-4 col-xs-12">
        <div class="mb-3">
            <label
                    ...
                    for="dateInput"
                    on:click={setDate}
                    on:keydown={setDate}>Datum</label
            >
            <input
                    bind:value={$metaInfo.date}
                    class="form-control"
                    id="dateInput"
                    type="date"
            />
...
<div class="row">
    <div class="col-sm-4 col-xs-12">
        <div class="mb-3">
            ...
            <input
                    bind:value={$metaInfo.chiefReferee}
                    class="form-control"
                    id="chiefRefereeInput"
                    type="text"
            />
        </div>
    </div>
